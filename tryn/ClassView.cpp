...
BEGIN_MESSAGE_MAP(CClassView, CDockablePane)
	...
	ON_COMMAND(ID_MENU_ZOOM_IN, &CClassView::OnMenuZoomIn)
	ON_COMMAND(ID_CREATE_PNT, &CClassView::OnCreatePnt)
	ON_WM_LBUTTONDOWN()
END_MESSAGE_MAP()
...
void CClassView::OnMenuZoomIn()
{
	// TODO: 在此添加命令处理程序代码
}

enum operatorType{ OPERSTATE_INPUT_POINT,OPERSTATE_EDOT_Line,OPERSTATE_REMOVE_POINT};


void CClassView::OnCreatePnt()
{
	// TODO: 在此添加命令处理程序代码
//	operType=OPERSTATE_INPUT_POINT;  //设置当前操作为造点操作
}
